...
namespace FOW.Remaster.Core
{
    ...
    public class FogOfWarManager : MonoBehaviour
    {
        ...
        public void AddFaction()
        {
            ...
            {
                Debug.LogWarning("[UltimateFogofWar] Cant add more Factions because the limit of " + revealFactions.Length + " is reached. Check the Documentation on how to add more Factions. (Default = 8)");
                return;
            }
        ...
        public void RemoveFaction(int i)
        {
            ...
            {
                Debug.LogWarning("[UltimateFogofWar] Could not remove Faction. Less than 1 Faction is not allowed.");
                return;
            }
        ...
        public void ShowFaction(int _Faction)
        {
            ...
            {
                Debug.LogWarning("[UltimateFogofWar] Cant reveal Faction, because it does not exist. Create more Factions.");
            }
        ...
        public void AnalyzeTerrain()
        {
            ...
            {
                Debug.Log("[UltimateFogofWar] No Data!");
            }
        ...
        public void LoadFogMaps(string _SaveName)
        {
            ...
            if (!Directory.Exists(Application.persistentDataPath + "/Saves/"))
            {
                Debug.LogWarning("[UltimateFogofWar] Directory does not exist! Savegame could not be loaded.");
            }
        ...
        public void PlacePrefab(Vector3 _Position, Quaternion _Rotation, bool _Snap, int _ID)
        {
            if (fogAlignment == FogOfWar.FogAlignment.Horizontal)
            {
                ...
                if (FogGO[coord] != null)
                {
                    Debug.LogWarning("[UltimateFogofWar]Can't place Vision Modifier. Position already contains a Vision Modifier.");
                    return;
                }
